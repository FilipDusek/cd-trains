...
Same pattern as fast-flights: state persists across CLI invocations and
parallel processes via SQLite + a file lock. Default rates are arbitrary —
cd.cz's threshold isn't published.
...
ENV_DISABLE = "CD_TRAINS_NO_RATE_LIMIT"
BUCKET_NAME = "cd-trains"
...
def _default_db_path() -> Path:
    ...
    return base / "cd-trains" / "ratelimit.sqlite"
